...
public class GetCardsOfUserQueryHandler(IAuthenticatedUserService authenticatedUserService, IUserDetailRepository userDetailRepository) : IRequestHandler<GetCardsOfUserQuery, BaseResult<UserDetailDto>>
    {
