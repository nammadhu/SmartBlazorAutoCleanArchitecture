...
public class Card_Repository(DbContextProvider dbContextProvider, IMapper mapper, ICardApprovalRepository townCardApprovalRepository, IIdentityRepository accountServices, IAuthenticatedUserService authenticatedUserService, IUserDetailRepository userDetailRepository,
IAzImageStorage azImageStorage) : GenericRepository<Card>(dbContextProvider: dbContextProvider), ICardRepository
{
    private DbContextProvider dbContextProvider = dbContextProvider;
    private IMapper mapper = mapper;
    private ICardApprovalRepository townCardApprovalRepository = townCardApprovalRepository;
    private IIdentityRepository accountServices = accountServices;
    private IAuthenticatedUserService authenticatedUserService = authenticatedUserService;
    private IAzImageStorage azImageStorage = azImageStorage;
