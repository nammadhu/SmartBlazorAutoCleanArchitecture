...
public class UserDetailRepository(DbContextProvider dbContextProvider, IIdentityRepository identityRepository, IMapper mapper) : GenericRepository<UserDetail>(dbContextProvider), IUserDetailRepository
...
/*
  public async Task<UserDetailDto> GetUserCardsMoreDetails(GetCardsOfUserQuery query, CancellationToken cancellationToken)
  {
      ...
      List<MyTown.Domain.CardApproval> cardApprovals = [];//TODO pending
